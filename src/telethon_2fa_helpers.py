...
class Secure2FAManager:
    ...
    async def set_2fa_password(self, client: TelegramClient, new_password: str, 
                              hint: str = '', email: Optional[str] = None) -> Tuple[bool, str]:
        """
        ...
        try:
            ...
            return False, f"Email confirmation required. A code was sent to {email}. Please confirm and try again."
    ...
    async def change_2fa_password(self, client: TelegramClient, current_password: str,
                                 new_password: str, hint: str = '', 
    ...
    async def remove_2fa_password(self, client: TelegramClient, 
...
class SecureInputManager:
    ...
    def get_numeric_keypad(self, callback_prefix: str) -> list:
        ...
        return [
            [Button.inline("1", f"{callback_prefix}:1"), Button.inline("2", f"{callback_prefix}:2"), Button.inline("3", f"{callback_prefix}:3")],
            [Button.inline("4", f"{callback_prefix}:4"), Button.inline("5", f"{callback_prefix}:5"), Button.inline("6", f"{callback_prefix}:6")],
            [Button.inline("7", f"{callback_prefix}:7"), Button.inline("8", f"{callback_prefix}:8"), Button.inline("9", f"{callback_prefix}:9")],
            [Button.inline("0", f"{callback_prefix}:0"), Button.inline("⌫", f"{callback_prefix}:back"), Button.inline("✅", f"{callback_prefix}:ok")],
    ...
    def get_full_keypad(self, callback_prefix: str) -> list:
        ...
        return [
            [Button.inline("1", f"{callback_prefix}:1"), Button.inline("2", f"{callback_prefix}:2"), Button.inline("3", f"{callback_prefix}:3"), Button.inline("4", f"{callback_prefix}:4"), Button.inline("5", f"{callback_prefix}:5")],
            [Button.inline("6", f"{callback_prefix}:6"), Button.inline("7", f"{callback_prefix}:7"), Button.inline("8", f"{callback_prefix}:8"), Button.inline("9", f"{callback_prefix}:9"), Button.inline("0", f"{callback_prefix}:0")],
            [Button.inline("q", f"{callback_prefix}:q"), Button.inline("w", f"{callback_prefix}:w"), Button.inline("e", f"{callback_prefix}:e"), Button.inline("r", f"{callback_prefix}:r"), Button.inline("t", f"{callback_prefix}:t")],
            [Button.inline("y", f"{callback_prefix}:y"), Button.inline("u", f"{callback_prefix}:u"), Button.inline("i", f"{callback_prefix}:i"), Button.inline("o", f"{callback_prefix}:o"), Button.inline("p", f"{callback_prefix}:p")],
            [Button.inline("a", f"{callback_prefix}:a"), Button.inline("s", f"{callback_prefix}:s"), Button.inline("d", f"{callback_prefix}:d"), Button.inline("f", f"{callback_prefix}:f"), Button.inline("g", f"{callback_prefix}:g")],
            [Button.inline("h", f"{callback_prefix}:h"), Button.inline("j", f"{callback_prefix}:j"), Button.inline("k", f"{callback_prefix}:k"), Button.inline("l", f"{callback_prefix}:l"), Button.inline("⇧", f"{callback_prefix}:shift")],
            [Button.inline("z", f"{callback_prefix}:z"), Button.inline("x", f"{callback_prefix}:x"), Button.inline("c", f"{callback_prefix}:c"), Button.inline("v", f"{callback_prefix}:v"), Button.inline("b", f"{callback_prefix}:b")],
            [Button.inline("n", f"{callback_prefix}:n"), Button.inline("m", f"{callback_prefix}:m"), Button.inline("⌫", f"{callback_prefix}:back"), Button.inline("✅ Done", f"{callback_prefix}:ok"), Button.inline("❌ Cancel", f"{callback_prefix}:cancel")]
        ]
    
    def start_secure_input(self, user_id: int, input_type: str, account_id: int = None) -> str:
