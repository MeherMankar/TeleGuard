...
from .constants import AppConstants, ConfigKeys, DEFAULT_CONFIG
...
class TelegramConfig:
    ...
    def __post_init__(self):
        ...
        if not self.api_hash or len(self.api_hash) != 32:
            raise ConfigurationError("API_HASH must be a 32-character hexadecimal string")
...
class ConfigManager:
    ...
    def _load_database_config(self) -> DatabaseConfig:
        ...
        return DatabaseConfig(
            ...
            redis_health_check_interval=self._get_int_env("REDIS_HEALTH_CHECK_INTERVAL", 30)
        )
    def _load_security_config(self) -> SecurityConfig:
        ...
        return SecurityConfig(
            ...
            session_backup_enabled=self._get_bool_env(ConfigKeys.SESSION_BACKUP_ENABLED, False),
    ...
    def _load_sessionmaster_config(self) -> SessionMasterConfig:
        ...
        return SessionMasterConfig(
            ...
            session_validation_interval=self._get_int_env('SM_SESSION_VALIDATION_INTERVAL', 3600),
            ...
            bulk_subscribe_delay=tuple(map(int, os.getenv('SM_BULK_SUBSCRIBE_DELAY', '1,3').split(','))),
            bulk_message_delay=tuple(map(int, os.getenv('SM_BULK_MESSAGE_DELAY', '2,5').split(','))),
    ...
    def _validate_configuration(self) -> None:
        ...
        if not self.telegram.api_id or not self.telegram.api_hash or not self.telegram.bot_token:
