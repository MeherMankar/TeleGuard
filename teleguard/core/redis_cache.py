...
class RedisCache:
    ...
    async def cache_user_accounts(self, user_id: int, accounts: List[Dict], ttl: int = 900):
    ...
    async def cache_multiple(self, cache_items: Dict[str, tuple], default_ttl: int = 3600):
    ...
    async def get_cache_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if hit_keys:
                ...
                stats["top_cache_hits"] = dict(zip([k.replace("cache_hits:", "") for k in hit_keys[:10]], hits))
