"""Unified Telegram Client Manager - Profile, Sessions, Automation, Lifecycle
Developed by:
- @Meher_Mankar
- @Gutkesh
            ...
            try:
                ...
                for client in idle_clients_to_disconnect.values():
                    try:
                        ...
                        logger.error(f"Error disconnecting idle client: {e}")
...
def init_client_manager(bot_instance, user_clients):
    ...
    client_manager = FullClientManager(bot_instance, user_clients)
    return client_manager
