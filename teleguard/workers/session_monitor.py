...
class SessionMonitor:
            ...
            for user_id, clients in self.bot_manager.user_clients.items():
                for account_name, client in list(clients.items()):
                    try:
                        ...
                        await self._handle_potential_invalidation(user_id, account_name, str(e))
        except Exception as e:
    ...
    async def _check_session_health(self, user_id: int, account_name: str, client):
        ...
        try:
            ...
            if any(phrase in error_msg for phrase in [
                ...
                "authorization key", "duplicated", "failed to get valid user info"
            ]):
    ...
    async def _handle_potential_invalidation(self, user_id: int, account_name: str, error_message: str):
