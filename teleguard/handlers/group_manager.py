...
class GroupManager:
    ...
    def register_handlers(self):
        ...
        self.bot.add_event_handler(
            self._show_group_menu, events.CallbackQuery(pattern=r"^group_manager$")
        )
        self.bot.add_event_handler(
            self._list_groups, events.CallbackQuery(pattern=r"^group_list:(.+)$")
        )
        self.bot.add_event_handler(
            self._leave_group, events.CallbackQuery(pattern=r"^group_leave:(.+):(.+)$")
        )
