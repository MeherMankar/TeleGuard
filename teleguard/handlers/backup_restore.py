...
class BackupRestore:
    ...
    def register_handlers(self):
        ...
        self.bot.add_event_handler(
            ...
            events.CallbackQuery(pattern=r"^backup_menu$")
        )
        self.bot.add_event_handler(
            self._create_backup,
            events.CallbackQuery(pattern=r"^backup_create$")
        )
    ...
    async def _create_backup(self, event):
        ...
        try:
            ...
            await self.bot.send_file(
                ...
                attributes=[DocumentAttributeFilename(f"teleguard_backup_{int(datetime.utcnow().timestamp())}.json")]
            )
