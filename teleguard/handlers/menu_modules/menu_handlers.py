...
class MenuHandlers:
    ...
    async def handle_account_settings(self, event):
        ...
        if not accounts:
            ...
            buttons = [[Button.inline("🚀 Add First Account", "account:add")], [Button.inline("🔐 Session Login", "session_login"), Button.inline("📥 Import Sessions", "import_sessions")], [Button.inline("❓ Setup Guide", "help:guide")], [Button.inline("🔙 Back to Main Menu", "menu:main")]]
        else:
            ...
            text += "\n🎛️ **Management Tools:**"
            buttons.extend([[Button.inline("➕ Add Account", "account:add"), Button.inline("🗑️ Remove Account", "account:remove")], [Button.inline("🔐 Login via Session", "session_login"), Button.inline("✨ Create Session", "export_sessions")], [Button.inline("🔄 Refresh Status", "account:refresh"), Button.inline("📋 Detailed List", "account:list")], [Button.inline("🔙 Back to Main Menu", "menu:main")]])
    ...
    async def handle_otp_manager(self, event):
        ...
        if not accounts:
            ...
            buttons = [[Button.inline("🚀 Add First Account", "account:add")], [Button.inline("❓ Security Guide", "help:security")], [Button.inline("🔙 Back to Main Menu", "menu:main")]]
        else:
            ...
            buttons = [[Button.inline("🛡️ OTP Destroyer", "otp_setting:destroyer"), Button.inline("📤 OTP Forward", "otp_setting:forward")], [Button.inline("⏰ Temp Bypass", "otp_setting:temp"), Button.inline("📊 Statistics", "otp:stats")], [Button.inline("🟢 Enable All Protection", "otp:enable_all"), Button.inline("🔴 Disable All Protection", "otp:disable_all")], [Button.inline("📋 Security Audit Log", "otp:audit_all")], [Button.inline("🔙 Back to Main Menu", "menu:main")]]
        await self.bot.send_message(user_id, text, buttons=buttons)
