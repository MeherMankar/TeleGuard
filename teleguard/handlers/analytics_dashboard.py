...
class AnalyticsDashboard:
    ...
    def register_handlers(self):
        ...
        self.bot.add_event_handler(
            ...
            events.CallbackQuery(pattern=r"^analytics$")
        )
        self.bot.add_event_handler(
    ...
    async def _show_analytics(self, event):
        ...
        try:
            ...
            for acc in accounts[:10]:
                ...
                buttons.append([Button.inline(f"📊 {name}", f"analytics_account:{name}")])
    ...
    async def _show_account_stats(self, event):
        ...
        try:
            ...
            text = (
                ...
                f"• Status: {'✅ Active' if account.get('is_active') else '❌ Inactive'}\n"
                f"• Activity Logs: {logs}\n"
                f"• OTP Destroyer: {'✅ Enabled' if account.get('otp_destroyer_enabled') else '❌ Disabled'}\n"
            )
