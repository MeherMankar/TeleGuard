...
from ..core.constants import Emojis, StatusCodes
...
class TelegramMessageFormatter:
    ...
    def format_success_message(
        title: str, details: str, emoji: str = Emojis.SUCCESS
    ) -> str:
        """
    ...
    def format_error_message(
        title: str, details: str, emoji: str = Emojis.ERROR
    ) -> str:
        """
    ...
    @staticmethod
    def format_info_message(title: str, details: str, emoji: str = Emojis.INFO) -> str:
        """
    ...
    def format_list_items(
        items: List[Dict[str, Any]], title: str = "Items", key_field: str = "name"
    ) -> str:
        """
...
class LogFormatter:
    ...
    def format_security_event(
        user_id: int, event_type: str, details: Optional[Dict] = None
    ) -> str:
        """
